	...
	if [ $year -eq $input_endyear ]
		then
			...
			for ((month=1; month<=input_endmonth; month++)); do
				...
				gmt psxyz $path/20${year2}_${month}.csv -R67/98/8/37/0/100 -Jx0.5c -Jz0.01 -So0.18c -Ggreen -W -p135/40/100 -L -K -O -P -Xf -Yf >> $path/20${year2}_${month}.ps;
